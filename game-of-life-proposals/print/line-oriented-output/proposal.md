...
let print_board = f(board: int32[][]): void =>
    let mutable row_index: int64 = 0
    while row_index < board.length:
        print_line(render_row(board[row_index]))
...
let print_generation = f(generation: int64, board: int32[][]): void =>
    print_line('generation {generation}')
    print_board(board)
    return void
```
