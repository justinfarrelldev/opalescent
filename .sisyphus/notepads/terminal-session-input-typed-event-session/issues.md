...
- 2026-08-22: Task 23 strict-clippy verification exposed a handful of existing `needless_borrowed_reference` patterns in adjacent terminal-affine checker/codegen files. Fixing them was required to keep `cargo clippy --all-targets --all-features -- -D warnings` green even though the main feature work was the prerequisite gate itself.
