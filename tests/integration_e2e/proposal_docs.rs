...
fn terminal_generated_testing_harness_proposal_file_exists_and_is_linked() {
    let proposal_path =
        Path::new("stdlib-proposals/terminal-generated-testing/harness-injected-fake-backend/proposal.md");
    assert!(
        proposal_path.exists(),
        "selected harness-injected fake-backend proposal file should exist"
    );

    let comparison = fs::read_to_string("stdlib-proposals/terminal-generated-testing/COMPARISON.md")
